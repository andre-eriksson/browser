...
pub struct Application {
    pub id: window::Id,
    window_manager: WindowController<Message, Theme, iced::Renderer>,
...
impl Application {
    pub fn new() -> (Self, Task<Message>) {
        ...
        let app = Application {
            id: main_window_id,
            window_manager: window_controller,
        ...
        match message {
            ...
            Message::CloseWindow(window_id) => {
                ...
                if window_id == self.id {
                    if self.window_manager.open_windows.is_empty() {
                        return iced::exit();
                    } else {
                        return self
                            .window_manager
    ...
    pub fn view(&self, window_id: window::Id) -> iced::Element<Message, Theme, Renderer> {
        self.window_manager.render(self, window_id)
    }

    pub fn title(&self, window_id: window::Id) -> String {
        self.window_manager.title(window_id)
    }
}
