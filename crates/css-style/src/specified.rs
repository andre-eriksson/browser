...
use crate::{
    ...
    global::Global,
    handler::{
        PropertyUpdateContext, handle_background, handle_background_attachment, handle_background_clip,
        handle_background_color, handle_background_origin, handle_background_position, handle_background_position_x,
        handle_background_position_y, handle_background_repeat, handle_background_size, handle_border,
        handle_border_bottom_color, handle_border_bottom_style, handle_border_bottom_width, handle_border_left_color,
        handle_border_left_style, handle_border_left_width, handle_border_right_color, handle_border_right_style,
        handle_border_right_width, handle_border_top_color, handle_border_top_style, handle_border_top_width,
        handle_color, handle_display, handle_font_family, handle_font_size, handle_font_weight, handle_height,
        handle_line_height, handle_margin, handle_margin_block, handle_margin_block_end, handle_margin_block_start,
        handle_margin_bottom, handle_margin_inline, handle_margin_inline_end, handle_margin_inline_start,
        ...
        handle_padding_bottom, handle_padding_inline, handle_padding_inline_end, handle_padding_inline_start,
        handle_padding_left, handle_padding_right, handle_padding_top, handle_position, handle_text_align,
        handle_whitespace, handle_width, handle_writing_mode,
    },
    properties::{
        AbsoluteContext, BackgroundAttachmentProperty, BackgroundClipProperty, BackgroundImageProperty,
        BackgroundOriginProperty, BackgroundPositionXProperty, BackgroundPositionYProperty, BackgroundRepeatProperty,
        BackgroundSizeProperty, BorderStyleValueProperty, BorderWidthValueProperty, CSSProperty, ColorProperty,
        ...
        for (key, value) in properties {
            ...
            match key {
                Property::Known(prop) => match prop {
                    KnownProperty::Background => handle_background(&mut ctx, v),
                    KnownProperty::BackgroundAttachment => handle_background_attachment(&mut ctx, v),
                    KnownProperty::BackgroundClip => handle_background_clip(&mut ctx, v),
                    KnownProperty::BackgroundColor => handle_background_color(&mut ctx, v),
                    KnownProperty::BackgroundOrigin => handle_background_origin(&mut ctx, v),
                    KnownProperty::BackgroundRepeat => handle_background_repeat(&mut ctx, v),
                    KnownProperty::BackgroundPosition => handle_background_position(&mut ctx, v),
                    KnownProperty::BackgroundPositionX => handle_background_position_x(&mut ctx, v),
                    KnownProperty::BackgroundPositionY => handle_background_position_y(&mut ctx, v),
                    KnownProperty::BackgroundSize => handle_background_size(&mut ctx, v),
