...
use crate::{
    ...
    handler::{
        ...
        handle_display, handle_float, handle_font_family, handle_font_size, handle_font_weight, handle_height,
        handle_left, handle_line_height, handle_margin, handle_margin_block, handle_margin_block_end,
    ...
    properties::{
        ...
        FontSizeProperty, FontWeightProperty, HeightProperty, LineHeightProperty, MaxHeightProperty, MaxWidthProperty,
...
pub struct SpecifiedStyle {
    ...
    pub bottom: OffsetValueProperty,
    ...
    pub right: OffsetValueProperty,
    pub text_align: TextAlignProperty,
    pub top: OffsetValueProperty,
