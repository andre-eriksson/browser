...
use crate::{
    ...
    properties::{
        ...
        CSSProperty, ClearProperty, ColorProperty, CursorProperty, DisplayProperty, FloatProperty, FontFamilyProperty,
        FontSizeProperty, FontWeightProperty, LineHeightProperty, MarginProperty, MaxSizeProperty, OffsetProperty,
        PositionProperty, SizeProperty, TextAlignProperty, WhitespaceProperty, WritingModeProperty,
    },
    rules::Rules,
