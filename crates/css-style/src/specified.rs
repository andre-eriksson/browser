...
use crate::{
    BorderStyleValue, BorderWidthValue, ComputedStyle, OffsetValue, RelativeContext,
...
impl From<ComputedStyle> for SpecifiedStyle {
    fn from(value: ComputedStyle) -> Self {
        Self {
            ...
            border_top_width: CSSProperty::from(BorderWidthValue::px(value.border_top_width)),
            border_right_width: CSSProperty::from(BorderWidthValue::px(value.border_right_width)),
            border_bottom_width: CSSProperty::from(BorderWidthValue::px(value.border_bottom_width)),
            border_left_width: CSSProperty::from(BorderWidthValue::px(value.border_left_width)),
