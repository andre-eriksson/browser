...
/// Generate a list of selector sequences from a list of component values
pub fn generate_selector_list(components: &[ComponentValue]) -> Vec<Vec<CompoundSelectorSequence>> {
    components
